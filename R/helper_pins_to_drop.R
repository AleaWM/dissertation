...
drop_parcels <- c(
  ...
  "0708109072",  # condo with spread outbuildings, doesn't seemto actually be in SFHA. maybeon edges.but some of the condos have massive growth amounts and are also skewing the models.
