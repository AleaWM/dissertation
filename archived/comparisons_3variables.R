...
compared_by3variables <- comparisons(triad_mod_4way,
  variables = "event",
  by = c("high_ff_score", "change_type", "Triad"),
  hypothesis = ~pairwise)

write_rds(compared_by3variables, "outputs/compared_by3variables.rds")
results <- read_rds("outputs/compared_by3variables.rds")
results
